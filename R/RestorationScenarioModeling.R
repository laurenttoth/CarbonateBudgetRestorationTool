...
#We could consider using size-specific mortality from Browne since we have estimated col diameters
#90% average colony diameters in FL <20 cm, so applying those rates:
#branching=0.0247, other=0.0176
branching_mortality<-0.0247
other_mortality<-0.0176
...
year_x_percentile <- length(baseline_budgets$rap[baseline_budgets$rap < year_x_site$rap]) /
  length(baseline_budgets$rap) * 100
>>>>>>> 3518ae03df94d28a3e5487f6dde28c023c49509e
